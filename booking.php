...
<body class="bg-light">
  ...
  if(!(isset($_SESSION['login']) && $_SESSION['login'] == true)){
    ...
    $q ="SELECT * FROM `user_cred` WHERE id= ?";
  ...
  <div class="container-fluid">
    <div class="row ">
      ...
      <div class="col-12 my-5 mb-5 px-4">
        <h2 class="fw-bold"><?php echo $user_r['name'] ?>'s BOOKING</h2>
        <div style="font-size: 14px;">
          <a href="index.php" class="text-secondary text-decoration-none">HOME</a>
          <span class="text-secondary">></span>
          <a href="booking.php" class="text-secondary text-decoration-none">BOOKING</a>
        </div>
      </div>
          ...
          $date = date("d-m-Y", strtotime($data['date_time']));
            ...
            if($data['booking_status']=='booked'){
              ...
              if($data['arrival'] == 1){
                ...
                if($data['rate_review'] == 0){
                  $btn .= "<button type ='button' onclick = 'review_room($data[booking_id],$data[room_id])' class='btn btn-dark btn-sm shadow-none ms-2'
                   data-bs-toggle='modal' data-bs-target='#reviewModal' data-bs-dismiss='modal'>Rate & Review</button>";
                }
            ...
            echo <<< booking
              <div class='col-md-4 px-4 mb-4'>
                ...
                <b>Date: </b>$date
                <br>
                <b>Total Paid: </b>RM $data[trans_amt]
                <br>
                </p>
                <p>
      ...
      <div class="modal-content">
        <form id="review-form">
          <div class="modal-header">
            <h5 class="modal-title  d-flex align-items-center"><i class="bi bi-chat-heart fs-3 me-2"></i>Rate & Review</h5>
          ...
          <div class="modal-body">
            <div class="mb-3">
                ...
                <select class="form-select shadow-none" name="rating">
                  <option hidden>How is your experience at our hotel</option>
            ...
            <div class="mb-4">
                ...
                <textarea name="review" id="" rows="5" class="form-control shadow-none" required></textarea>
            </div>
            <input type="hidden" name="booking_id">
            <input type="hidden" name="room_id">
          </div>
            <div class="modal-footer">
              <button type="reset"  class="btn btn-sm text-secondary shadow-none" data-bs-dismiss="modal">CANCEL</button>
  ...
  <script>
    function cancel_booking(id){
      if(confirm('Please confirm to cancel booking')){
