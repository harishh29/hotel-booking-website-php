<?php 
    ...
    if(isset($_GET['gen_pdf'])&& isset($_GET['id'])){
        ...
        if($data['booking_status']=='booked'){
            $sub_head = "Thank you for choosing our hotel. Please enjoy your stay!";
        }
        else if ($data['booking_status']=='cancelled' && $data['refund'] = 1){
            $sub_head = "Your payment has been refunded! ";
        }
        ...
        <table border='1'>
            ...
            <tr>
                ...
                <td>Price: RM $data[price] per night</td>
            </tr>
            <tr>
        ...
        if($data['booking_status']=='cancelled'){
            ...
            $table_data .= "<tr>
                <td>Amount Paid: RM $data[trans_amt]</td>
                <td>Refund: $refund</td>
            </tr>";
        }
        else{
